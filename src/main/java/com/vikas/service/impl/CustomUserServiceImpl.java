...
public class CustomUserServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        if (username.startsWith(SELLER_PREFIX)) {
            ...
            if (seller != null) {
                return buildUserDetail(seller.getEmail(), seller.getPassword(), seller.getRole(), true);
            }
        } else {
    ...
    private UserDetails buildUserDetail(String email, String password, USER_ROLE role, boolean enabled) {
